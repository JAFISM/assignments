              ...
              children: [
                GestureDetector(
                  child: Icon(
                    CupertinoIcons.home,
                    size: 35,
                    color: selected == 0 ? const Color(0xffB721FF) : Colors.white,
                  ),
                  onTap: () {
                    setState(() {
                      selected = 0;
                ...
                GestureDetector(
                    ...
                    child: Icon(
                      CupertinoIcons.brightness,
                      size: 35,
                      color: selected == 1 ? const Color(0xffB721FF) : Colors.white,
                    )),
                GestureDetector(
                    onTap: () {
                      setState(() {
                    ...
                    child: Icon(
                      CupertinoIcons.tv,
                      size: 35,
                      color: selected == 2 ? const Color(0xffB721FF) : Colors.white,
                    )),
                GestureDetector(
                    onTap: () {
                      setState(() {
                    ...
                    child: Icon(
                      CupertinoIcons.wind_snow,
                      size: 35,
                      color: selected == 3 ? const Color(0xffB721FF) : Colors.white,
                    ))
              ],
            ),
          ),
